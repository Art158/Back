(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".reviews-swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const slides = document.querySelectorAll(".accordion__slide");
        slides.forEach((slide => {
            slide.addEventListener("click", (() => {
                slides.forEach((s => s.classList.remove("accordion__slide--active")));
                slide.classList.add("accordion__slide--active");
            }));
        }));
    }));
    const scrollContainer = document.querySelector(".services__bottom");
    let isDown = false;
    let startX;
    let scrollLeft;
